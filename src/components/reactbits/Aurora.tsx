...
export default function Aurora({ colorStops = ['#3A29FF', '#FF94B4', '#FF3232'], amplitude = 1.0, blend = 0.5, className = '', ...rest }: AuroraProps) {
  const propsRef = useRef({ colorStops, amplitude, blend, ...rest });
